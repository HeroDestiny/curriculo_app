    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
        <header class="mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl">
            <nav class="flex items-center justify-between gap-4">
                <Link
                    href="/curriculos/enviar"
                    class="inline-block rounded-sm border border-[#19140035] bg-indigo-600 px-5 py-1.5 text-sm leading-normal text-[#1b1b18] text-white hover:border-[#1915014a] hover:bg-indigo-700 dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]"
                >
                    Enviar Currículo
                </Link>

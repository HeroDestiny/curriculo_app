...
<template>
    <AuthBase title="Acesse sua conta" description="Digite seu email e senha para fazer login">
        <Head title="Entrar" />
        ...
        >
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="password" type="password" name="password" required :tabindex="2" autocomplete="current-password" placeholder="Senha" />
